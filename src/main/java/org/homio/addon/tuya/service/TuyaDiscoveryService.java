...
public class TuyaDiscoveryService implements ItemDiscoverySupport {
  ...
  public @Nullable DeviceScannerResult scan(@NotNull Context context, @NotNull ProgressBar progressBar) {
    ...
    try {
      TuyaProjectEntity tuyaProjectEntity = context.db().getRequire(TuyaProjectEntity.class, PRIMARY_DEVICE);
  ...
  public List<TuyaDeviceDTO> getDeviceList(Context context) {
    ...
    TuyaProjectEntity entity = context.db().getRequire(TuyaProjectEntity.class, PRIMARY_DEVICE);
